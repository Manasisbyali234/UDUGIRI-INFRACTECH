      ...
      <section className="page-section">
        <div className="container">
          ...
          <div className="content-section">
            ...
            <div className="cards-grid">
              <div className="card">
                <h3>Integrity</h3>
                <p>
                  We conduct our business with honesty, transparency, and ethical practices, building trust with 
                  clients, partners, and stakeholders through consistent, principled actions.
                </p>
              </div>
              <div className="card">
                <h3>Excellence</h3>
                <p>
                  Pursuing the highest standards in everything we do, we strive for continuous improvement and 
                  exceptional quality in service delivery and project outcomes.
                </p>
              </div>
              <div className="card">
                <h3>Innovation</h3>
                <p>
                  Embracing change and technological advancement, we continuously explore new methodologies and 
                  tools to enhance our capabilities and deliver superior solutions.
                </p>
              </div>
              <div className="card">
                <h3>Collaboration</h3>
                <p>
                  Fostering teamwork and partnership, we believe in collective expertise and open communication 
              ...
              <div className="card">
                ...
                <p>
                  Taking ownership of our commitments and responsibilities, we ensure reliable delivery and stand 
                  behind the quality of our work with complete dedication.
                </p>
              </div>
              <div className="card">
                <h3>Customer Focus</h3>
                <p>
                  Placing client needs at the center of our operations, we tailor our services to meet specific 
                  requirements and exceed expectations consistently.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="content-section">
            ...
            <ul>
              <li><strong>Requirement Analysis:</strong> Thorough understanding of client needs and project specifications</li>
              <li><strong>Strategic Planning:</strong> Developing comprehensive execution plans with clear milestones</li>
              <li><strong>Technology Integration:</strong> Leveraging appropriate tools and technologies for optimal results</li>
              <li><strong>Quality Assurance:</strong> Implementing rigorous quality control measures at every stage</li>
              <li><strong>Timely Delivery:</strong> Adhering to project timelines while maintaining quality standards</li>
              <li><strong>Continuous Support:</strong> Providing post-delivery assistance and maintenance services</li>
            </ul>
          </div>
